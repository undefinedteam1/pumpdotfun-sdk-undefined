import { Commitment, Connection, Finality, Keypair, PublicKey, Transaction, VersionedTransaction } from "@solana/web3.js";
...
export declare const getTxDetails: (connection: any, signature: any, commitment?: any) => Promise<any>;
